...
<table cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;font-family:Arial,Helvetica,sans-serif;color:#1a1a1a;line-height:1.45;">
    <tr>
        ...
        <td style="vertical-align:top;">
            ...
            <?php if ( $title ) : ?>
                <div style="font-size:<?php echo (int) $contact_size; ?>px;color:#5f6368;"><?php echo esc_html( $title ); ?><?php if ( $company ) : ?> — <strong style="color:#1a1a1a;"><?php echo esc_html( $company ); ?></strong><?php endif; ?></div>
            <?php elseif ( $company ) : ?>
                <div style="font-size:<?php echo (int) $contact_size; ?>px;color:#5f6368;"><strong style="color:#1a1a1a;"><?php echo esc_html( $company ); ?></strong></div>
            <?php endif; ?>
